...
velocidad1 = int(input("Dime la velocidad del coche 1 (km/h) :"))
velocidad2 = int(input("Dime la velocidad del coche 2 (mas pequeña)(km/h) :"))
distancia = int(input("Dime la distancia entre los dos coches (km):"))
